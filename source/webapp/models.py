...
class ArticleLike(models.Model):
    user = models.ForeignKey(get_user_model(), related_name='article_likes',
...
class CommentLike(models.Model):
    user = models.ForeignKey(get_user_model(), related_name='comment_likes',
                             verbose_name='Пользователь', on_delete=models.CASCADE)
    comment = models.ForeignKey('webapp.Comment', on_delete=models.CASCADE,
                                related_name='likes', verbose_name='Комменатрий')
